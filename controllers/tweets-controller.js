...
exports.tweetNew = (req, res, next) => {
  console.log('Nouveau Tweet', req.isAuthenticated());
  res.render('tweets/tweet-form',
    {
      tweet: {}, isAuthenticated: req.isAuthenticated(),
      currentUser: req.user
    });
}
...
exports.tweetCreate = async (req, res, next) => {
  try {
    console.log('Creation Tweet', req.body);
    const body = req.body;
...
exports.tweetDelete = async (req, res, next) => {
  try {
    ...
    console.log('Suppression Tweet', tweetId);
